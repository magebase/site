...
# Hetzner Cloud Provider - REMOVED: Not needed for AWS Organizations & SSO setup
# provider "hcloud" {
#   token = var.hcloud_token
# }

# Cloudflare Provider - REMOVED: Not needed for AWS Organizations & SSO setup
# provider "cloudflare" {
#   api_token = var.cloudflare_api_token
# }

# AWS Provider (for SES only) - REMOVED: Not needed for AWS Organizations & SSO setup
# provider "aws" {
#   alias  = "ses"
...
# K3s Cluster Module - REMOVED: All k3s resources are now controlled by infra/kube.tf
# module "k3s_cluster" {
...
# Cloudflare DNS Configuration - REMOVED: Not needed for AWS Organizations & SSO setup
...
# AWS SES Configuration - REMOVED: Not needed for AWS Organizations & SSO setup
# module "aws_ses" {
...
# Outputs - Only AWS Organizations & SSO related outputs
output "cluster_name" {
  value = local.cluster_name
  description = "Cluster name for reference"
}

# AWS SES Configuration outputs - REMOVED: Not needed for AWS Organizations & SSO setup
# output "cloudflare_zone_id" {
#   value = module.cloudflare_dns.zone_id
# }

# K3s cluster outputs - REMOVED: All k3s resources controlled by infra/kube.tf
# output "kubeconfig" {
